...
def merge_files():
    # Read the CSVs
    dbgap_vars = pd.read_csv('./copies_of_external_source_files/dbgap_variables_priority_cohorts.csv')
    ...
    # anti-join, raw_to_harm but not in dbgap_vars
    outer = raw_to_harm.merge(dbgap_vars, how='outer', indicator=True, on='phv_number')
